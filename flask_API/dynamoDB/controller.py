...
def write_to_foodList(id, ingredients, description):
    print(id, ingredients, description)
    print("------------")
    response = FoodListTable.put_item(
        Item={"id": id, "ingredients": ingredients, "description": description}
    )
    print(response)
    return response
...
# write_to_foodList(
#     1,
#     [{"name": "beef", "amount": "100g"}, {"name": "pork", "amount": "200g"}],
#     "duc's food",
# )
