...
const MacroCal = ({toast, showFront, setShowFront, setMacro, userMacro}) => {
    ...
    const [calories, setCalories] = useState(userMacro.kcal);
    const [fat, setFat] = useState(userMacro.fat);
    const [protein, setProtein] = useState(userMacro.protein);
    const [carbs, setCarbs] = useState(userMacro.carbs);
    const [fiber, setFiber] = useState(userMacro.fibre);
    const [sodium, setSodium] = useState(2300);
    const [sugars, setSugars] = useState(userMacro.sugars);
    const [saturates, setSaturates] = useState(userMacro.saturates);
        ...
        <div className="cal-container">
            <div className="flippable-card-container">
                <div className="card-cal">
                    {showFront ? (<div className="card-front calulator-container">
